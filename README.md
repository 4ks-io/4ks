...
- Docker base images are pinned by tag and digest in repo-owned Dockerfiles. Dependabot is currently disabled until the planned framework and dependency upgrade stories are completed.
